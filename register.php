...
</li><li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" href="insert_product.php" style="padding: 10px 20px;">Contact</a>
          ...
          <div class="u-container-layout u-valign-middle u-container-layout-1">
            ...
            <div class="u-expanded-width u-form u-login-control u-form-1">
              <form action="#" method="POST" class="u-clearfix u-form-custom-backend u-form-spacing-35 u-form-vertical u-inner-form" source="custom" name="form-2" style="padding: 10px;">
                ...
                <div class="u-form-group u-form-name">
                  <label for="username-708d" class="u-form-control-hidden u-label"></label>
                  <input type="text" placeholder="Enter your full name" id="username-708d" name="fullname" class="u-grey-5 u-input u-input-rectangle" required="">
                </div>
                ...
                <div class="u-form-group u-form-password">
                  <label for="password-708d" class="u-form-control-hidden u-label"></label>
                  <input type="text" placeholder="Conform your Password" id="password-708d" name="c_password" class="u-grey-5 u-input u-input-rectangle" required="">
                </div>
