      ...
      <div class="u-clearfix u-sheet u-sheet-1">
        <div class="u-align-center u-container-style u-group u-radius-50 u-shape-round u-white u-group-1">
          <div class="u-container-layout u-valign-middle u-container-layout-1">
            <h3 class="u-text u-text-default u-text-1">  Add new song</h3>
            <div class="u-expanded-width u-form u-login-control u-form-1">
              <form action="" method="POST" enctype="multipart/form-data" class="u-clearfix u-form-custom-backend u-form-spacing-35 u-form-vertical u-inner-form" source="custom" name="form-2" style="padding: 10px;">
                <div class="u-form-group u-form-name">
                  ...
                  <input type="text" placeholder="Enter product name" id="username-708d" name="product_name" class="u-grey-5 u-input u-input-rectangle" required="" size="60">
                </div>
                <div class="u-form-group u-form-name">
                  <label for="username-708d" class="u-form-control-hidden u-label"></label>
                  <input type="file" placeholder="add image file" id="username-708d" name="product_image" class="u-grey-5 u-input u-input-rectangle" required="">
                </div>
                <div class="u-form-group u-form-password">
                  <label for="password-708d" class="u-form-control-hidden u-label"></label>
                  <input type="text" placeholder="Enter product price" id="password-708d" name="product_price" class="u-grey-5 u-input u-input-rectangle" required="">
              ...
              $sql = "INSERT INTO product VALUES (NULL,'$product_name','$product_image','$product_price') ";
